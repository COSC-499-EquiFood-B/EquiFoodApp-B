...
class RestaurantapprovedWidget extends StatefulWidget {
  const RestaurantapprovedWidget({Key? key}) : super(key: key);

  @override
  _RestaurantapprovedWidgetState createState() =>
      _RestaurantapprovedWidgetState();
}

class _RestaurantapprovedWidgetState extends State<RestaurantapprovedWidget> {
