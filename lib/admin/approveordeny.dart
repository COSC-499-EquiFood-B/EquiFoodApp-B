...
class ApproveordenyWidget extends StatefulWidget {
  const ApproveordenyWidget({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(14, 16, 0, 0),
                        child: Text(
                          'Restaurant Name',
                    ...
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(14, 8, 0, 0),
                      child: Text(
                    ...
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(14, 12, 0, 4),
                      child: Text(
                        'Location:',
